  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.36.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.36.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.36.tgz':
    resolution: {integrity: sha512-mI8J9KcL8j7OeKkswOM6wpvSiKZdH0yVe89RzAMrdxqpMMIdKf64O/rrysSnuvHmmereUKDQ54AQmz5yOIMalw==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.36.tgz}
    version: 2.8.36
    bundledDependencies:
      - '@oai/embedded-fonts'
      - '@oai/walnut'
