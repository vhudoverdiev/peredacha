...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.36.tgz':
    resolution: {integrity: sha512-W8qPRSr5eYABozt5mCdDeHn6CKJdMXE5olAQqjrm3Bf9FzazO/cvBX2TB/XNYNi5kgHxPboZ5Nj10Fh096qtyg==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.36.tgz}
    version: 2.8.36
    bundledDependencies:
      - '@oai/embedded-fonts'
      - '@oai/walnut'
