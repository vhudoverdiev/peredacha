const STATIC_CACHE = 'peredacha-static-v57-mobile-empty-table-immediate';
const STATIC_ASSETS = [
  ...
  '/static/style.css?v=v617-mobile-empty-spacing-final',
  '/static/mobile-only.css?v=v47-mobile-empty-table-immediate',
