const STATIC_CACHE = 'peredacha-static-v95-issued-empty-shared-dock';
const STATIC_ASSETS = [
  ...
  '/static/mobile-only.css?v=v77-issued-empty-shared-dock',
  '/static/desktop-only.css?v=v41-glass-search-spare',
